...
在场景A（生产系统占优场景，p=0.65）下，PBNE-1 的防御者期望效用为 -5.1741，优于真实披露基线的 -7.7790。这说明当真实系统在目标集合中占据较高比例时，生产系统以一定概率伪装为蜜罐信号，能够有效抑制攻击者的攻击收益预期，并改善防御方总体收益。

在场景B（蜜罐占优场景，p=0.35）下，PBNE-2 的防御者期望效用为 6.1792，同样优于真实披露基线的 -4.3590。这说明当环境中蜜罐比例较高时，蜜罐通过伪装成正常系统可以更有效地吸引攻击者进入陷阱，并为防御方带来更高的情报收益。
